...
<body>
	...
	<div class="container">
		...
		<label class="alinear_a_emocional"><span class="glyphicon glyphicon-star"></span> Total Alteraciones Emocionales : <input type="text" class="btn btn-danger btn-xs" value="<?php echo $total_a_emocional; ?>" disabled></label>
	</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><span class="fa fa-plus-square"></span> Registro de Nueva Alteracion Emocional</h4>
				</div>
	...
	<div class="modal fade" id="update_value_item">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title"><span class="fa fa-cog"></span> Editar Valores de Cada Alteracion Emocional</h4>
				</div>
							...
							foreach ($show as $item) {
								echo "<div class='container-fluid row'>";
										echo "<div class='col-md-6'>";
											panel_info_for_modal("panel-info", $item['nombre_emocional'], "
												<form action='actualizar_valores_emocional.php' method='POST' name='items_emocional'>
													<input type='text' id='test' name='input_test' value='este es el contenido' hidden>
													<input type='text' id='sintoma$item[valor_emocional]' value='$item[valor_emocional]' class='form-control' disabled>
													<input type='checkbox' id='active_item_sintomas' value='sintoma$item[id_emocional]' name='active_item' onclick='active_input(this.form.input_test.value)'>");
										echo "</div>";
									echo "<div>";
							}
