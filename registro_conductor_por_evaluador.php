<?php
	...
	$identificacion_evaluador = "Evaluador : ".$_SESSION['name_user']." ID : ".$_SESSION['id_usuario'];
	...
	switch ($captura) {
		#Cuando se carga una imagen es verdadero
		case true:
			#Cambiar el nombre de la imagen cargada por uno mas descriptivo
				$new_name_photo = "contenido/Conductor/Por Evaluador/CC-".$traer_Valores_Conductor[3].".jpg";
