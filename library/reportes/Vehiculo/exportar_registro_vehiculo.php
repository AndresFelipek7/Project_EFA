<?php
	...
	$id_vehiculo = $_GET['id_vh'];
	$query = "SELECT * FROM reporte_vehiculo WHERE id_vehiculo = '$id_vehiculo'";
...
<body>
	...
	<div id="logo_empresa">
		...
		<h1 class="titulo">Reporte Vehiculos con ID <?php echo $id_vehiculo; ?></h1>
	</div>
	...
	<center>
		...
		?>
		<label>ID Vehiculo :</label> <?php echo $row['id_vehiculo']; ?><br>
		<label>Nombre Empresa :</label> <?php echo $row['nombre_empresa']; ?><br>
		<label>Marca :</label> <?php echo $row['marca']; ?><br>
		<label>Numero Interno :</label> <?php echo $row['numero_interno']; ?><br>
		<label>Placa :</label> <?php echo $row['placa']; ?><br>
		<label>Modelo :</label> <?php echo $row['modelo']; ?><br>
		<?php
			}
		?>
		<hr>
...
<?php
	...
	$filename = "Vehiculo_$id_vehiculo.pdf";
