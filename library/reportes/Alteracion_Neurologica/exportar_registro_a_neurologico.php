<?php
	...
	$id_neurologico = $_GET['id_neu'];
	$query = "SELECT * FROM reporte_a_neurologico WHERE id_neurologico = '$id_neurologico'";
...
<body>
	...
	<div id="logo_empresa">
		...
		<h1 class="titulo">Reporte Alteracion Neurologico con ID <?php echo $id_neurologico; ?></h1>
	</div>
	...
	<center>
		...
		?>
		<label>ID neurologico :</label> <?php echo $row['id_neurologico']; ?><br>
		<label>Nombre neurologico :</label> <?php echo $row['nombre_neurologico']; ?><br>
		<label>Descripcion neurologico :</label> <?php echo $row['descripcion_neurologico']; ?><br>
		<?php
			}
		?>
		<hr>
...
<?php
	...
	$filename = "Alteracion Neurologica $id_neurologico.pdf";
