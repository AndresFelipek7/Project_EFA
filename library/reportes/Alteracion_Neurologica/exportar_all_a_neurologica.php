<?php
	...
	include ("../../conec.php");
	$query = "SELECT * FROM reporte_a_neurologico";
...
<body>
	...
	<div id="logo_empresa">
		...
		<h1 class="titulo">Reporte Alteraciones Neurologicas</h1>
	</div>
	
	<table>
		<tr>
			<th>ID Alteracion Neurologica</th>
		...
		<tr>
			<td><?php echo $row['id_neurologico']; ?></td>
			<td><?php echo $row['nombre_neurologico']; ?></td>
			<td><?php echo $row['descripcion_neurologico']; ?></td>
		</tr>
		<?php
			}
		?>
...
<?php
	...
	$filename = "Reporte Alteraciones Neurologicas.pdf";
