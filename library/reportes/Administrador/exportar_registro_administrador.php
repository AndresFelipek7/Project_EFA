<?php
	...
	$Documento = $_GET['dc'];
	$query = "SELECT * FROM reporte_administrador_activo WHERE documento = '$Documento'";
...
<body>
	...
	<div id="logo_empresa">
		...
		<h1 class="titulo">Reporte Administrador con Documento <?php echo $Documento; ?></h1>
	</div>
	<center>
		<?php
...
<?php
	...
	$filename = "Reporte Administrador_$Documento.pdf";
