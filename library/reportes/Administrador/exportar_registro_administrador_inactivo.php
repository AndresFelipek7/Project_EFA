<?php
	...
	$valor_documento = $_GET['ad'];
	$query = "SELECT * FROM reporte_administrador_inactivo WHERE documento = '$valor_documento'";
...
<body>
	...
	<div id="logo_empresa">
		...
		<h1 class="titulo">Reporte Administrador con Documento <?php echo $valor_documento; ?></h1>
	</div>
	<center>
		<?php
			foreach ($result as $row ) {
				...
				*/
				...
				if ($row["correo"] == "") {
					$valor_correo_admin = "No se ha ingresado correo";
				}else {
		...
		<label>Correo :</label> <?php echo $valor_correo_admin; ?><br>
...
<?php
	...
	$filename = "Administrador_$valor_documento.pdf";
