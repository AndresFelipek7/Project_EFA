<?php
	...
	$id_sintoma = $_GET['id_sin'];
	$query = "SELECT * FROM reporte_sintomas WHERE id_sintoma = '$id_sintoma'";
...
<body>
	...
	<div id="logo_empresa">
		...
		<h1 class="titulo">Reporte Sintoma con ID <?php echo $id_sintoma; ?></h1>
	</div>
	...
	<center>
		...
		?>
		<label>ID Sintoma :</label> <?php echo $row['id_sintoma']; ?><br>
		<label>Nombre Sintoma :</label> <?php echo $row['nombre_sintoma']; ?><br>
		<label>Descripcion Sintoma :</label> <?php echo $row['descripcion_sintoma']; ?><br>
		<?php
			}
		?>
		<hr>
...
<?php
	...
	$filename = "Sintoma_$id_sintoma.pdf";
