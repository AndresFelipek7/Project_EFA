<?php
	...
	include ("../../conec.php");
	$query = "SELECT * FROM reporte_sintomas";
...
<body>
	...
	<div id="logo_empresa">
		...
		<h1 class="titulo">Reporte Sintomas</h1>
	</div>
	...
	<table>
		...
		<tr>
			<td><?php echo $row['id_sintoma']; ?></td>
			<td><?php echo $row['nombre_sintoma']; ?></td>
			<td><?php echo $row['descripcion_sintoma']; ?></td>
		</tr>
		<?php
			}
		?>
