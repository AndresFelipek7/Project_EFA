<?php
	...
	$query = "SELECT * FROM reporte_conductor_activo WHERE documento = '$valor_documento'";
...
<body>
	...
	<div id="logo_empresa">
		...
		<h1 class="titulo">Reporte Conductor con Documento <?php echo $valor_documento; ?></h1>
	</div>
	...
	<center>
		...
		<label>ID Conductor :</label> <?php echo $row['id_conductor']; ?><br>
...
<?php
	...
	$filename = "Conductor $valor_documento.pdf";
