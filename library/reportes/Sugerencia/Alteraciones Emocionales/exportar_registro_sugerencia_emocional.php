<?php
	...
	$query = "SELECT * FROM reporte_a_emocional_sugerencia WHERE id_sugerencia = '$id_sugerencia'";
...
<body>
	...
	<div id="logo_empresa">
		...
		<h1 class="titulo">Reporte Alteracion Emocional con ID <?php echo $id_sugerencia; ?></h1>
	</div>
	...
	<table>
		<tr>
			<th>ID Sugerencia</th>
			<th>Orden Reposo</th>
			<th>Nombre Alteracion Emocional</th>
			<th>Descripcion</th>
		</tr>
		<?php
		...
		<tr>
			...
			<td><?php echo $row['nombre_emocional']; ?></td>
...
<?php
	...
	$filename = "Reporte Sugerencia Alteracion Emocional con ID_$id_sugerencia.pdf";
