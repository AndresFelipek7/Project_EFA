<?php
	...
	include ("../../../conec.php");
	$query = "SELECT * FROM reporte_a_emocional_sugerencia";
...
<body>
	...
	<div id="logo_empresa">
		...
		<h1 class="titulo">Reporte Alteracion Emocional con Sugerencia</h1>
	</div>
...
<?php
	...
	$filename = "Reporte Alteracion Emocional con Sugerencia.pdf";
