<?php
	...
	include ("../../../conec.php");
	$query = "SELECT * FROM reporte_a_neurologico_sugerencia";
...
<body>
	...
	<div id="logo_empresa">
		...
		<img src="../../../../images/Logos Empresa/icono_empresa2.PNG">
			<h1 class="titulo">Reporte Alteracion Neurologica con Sugerencia</h1>
	</div>
...
<?php
	...
	$filename = "Reporte Alteracion Neurologica con Sugerencia.pdf";
