<?php
	...
	$query = "SELECT * FROM reporte_signo_sugerencia WHERE id_sugerencia = '$id_sugerencia'";
...
<body>
	...
	<div id="logo_empresa">
		...
		<h1 class="titulo">Reporte Signos con ID <?php echo $id_sugerencia; ?></h1>
	</div>
	...
	<table>
		...
		<tr>
			...
			<td><?php echo $row['nombre_signo']; ?></td>
...
<?php
	...
	$filename = "Reporte Sugerencia Signos con ID_$id_sugerencia.pdf";
