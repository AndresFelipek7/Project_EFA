<?php
	...
	$query = "SELECT * FROM reporte_sintomas_sugerencia WHERE id_sugerencia = '$id_sugerencia'";
...
<body>
	...
	<div id="logo_empresa">
		...
		<h1 class="titulo">Reporte Sintoma con ID <?php echo $id_sugerencia; ?></h1>
	</div>
	...
	<table>
		...
		<tr>
			...
			<td><?php echo $row['nombre_sintoma']; ?></td>
...
<?php
	...
	$filename = "Reporte Sugerencia Sintoma con ID_$id_sugerencia.pdf";
